                ...
                <Container fluid>
                    <Offcanvas.Header closeButton>
                        <Navbar.Brand>
                            ...
                            <h4 className="logo-title">ON-SHOOL</h4>
                        </Navbar.Brand>
                    ...
                    <Nav className='iq-nav-menu'>
                        ...
                        <Nav.Item as="li"><Link className={`${location.pathname === '/index-dual-compact' ? 'active' : ''} nav-link `} to="/index-dual-compact"><span className="item-name">ON-SCHOLL</span></Link></Nav.Item>
