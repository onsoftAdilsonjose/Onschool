...
const VerticalNavSecretario = memo(() => {
            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
                <li className="nav-item static-item">
                    <Link className="nav-link static-item disabled text-start" to="#" tabIndex="-1">
                        <span className="default-icon">Home- secretario</span>
                ...
                <li className={`${location.pathname === '/admin/dashboard' ? 'active' : ''} nav-item `}>
                    <Link className={`${location.pathname === '/admin/dashboard' ? 'active' : ''} nav-link `} aria-current="page" to="/admin/dashboard">
                        <OverlayTrigger placement="right" overlay={<Tooltip>Secretario</Tooltip>}>
                            <i className="icon">
...
VerticalNavSecretario.displayName = "VerticalNavSecretario"
export default VerticalNavSecretario
