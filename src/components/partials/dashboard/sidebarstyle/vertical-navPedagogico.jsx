...
const VerticalNavPedagogico = memo(() => {
            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li className={`${location.pathname === '/admin/dashboard' ? 'active' : ''} nav-item `}>
                    <Link className={`${location.pathname === '/admin/dashboard' ? 'active' : ''} nav-link `} aria-current="page" to="/admin/dashboard">
                        <OverlayTrigger placement="right" overlay={<Tooltip>Pedagogico</Tooltip>}>
                            <i className="icon">
...
VerticalNavPedagogico.displayName = "VerticalNavPedagogico"
export default VerticalNavPedagogico
