            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <Accordion.Item as="li" eventKey="dadospedagogicos" bsPrefix={`nav-item ${active === 'dadospedagogicos' ? 'active' : ''} `} onClick={() => setActive('dadospedagogicos')} >
                    ...
                    <Accordion.Collapse eventKey="dadospedagogicos" >
                        <ul className="sub-nav">
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/professorClasse' ? 'active' : ''} nav-link`} to="/admin/professorClasse">
                                    <i className="icon svg-icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>professor para classe</Tooltip>}>
                                        <i className="sidenav-mini-icon">DC</i>
                                    </OverlayTrigger>
                                    <span className="item-name">professor a classe</span>
                                </Link>
                            </Nav.Item>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix={`nav-item ${active === 'user' ? 'active' : ''} `} onClick={() => setActive('user')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/app/user-encarregado' ? 'active' : ''} nav-link`} to="/admin/app/user-encarregado">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Encarregado</Tooltip>}>
                                        <i className="sidenav-mini-icon"> E </i>
                                    </OverlayTrigger>
                                    <span className="item-name">Encarregado</span>
                                </Link>
                            </Nav.Item>
                        </ul>
                    </Accordion.Collapse>
                ...
                <Accordion.Item as="li" eventKey="sidebar-auth" bsPrefix={`nav-item ${active === 'auth' ? 'active' : ''} `} onClick={() => setActive('user')} >
                    ...
                    <Accordion.Collapse eventKey="sidebar-auth">
                        <ul className="sub-nav">
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/funcionario' ? 'active' : ''} nav-link`} to="/admin/funcionario">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Funcionário</Tooltip>}>
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/admin' ? 'active' : ''} nav-link`} to="/admin/admin">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <Accordion.Item as="li" eventKey="areaPedagogica" bsPrefix={`nav-item ${active === 'areaPedagogica' ? 'active' : ''} `} onClick={() => setActive('areaPedagogica')} >
                    ...
                    <Accordion.Collapse eventKey="areaPedagogica">
                        <ul className="sub-nav">
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/notas' ? 'active' : ''} nav-link`} to="/admin/notas">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/pautas' ? 'active' : ''} nav-link`} to="/admin/pautas">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/estudante/list' ? 'active' : ''} nav-link`} to="/admin/estudante/list">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Estudante</span>
                                </Link>
                            </Nav.Item>

                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/professor/list' ? 'active' : ''} nav-link`} to="/admin/professor/list">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
           ...
           {/**Area financeira */}
                ...
                <Accordion.Item as="li" eventKey="sidebar-ui" bsPrefix="nav-item">
                    ...
                    <Accordion.Collapse eventKey="sidebar-ui">
                        <ul className="sub-nav">
                        <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/Pagamento' ? 'active' : ''} nav-link`} to="/admin/Pagamento">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Pagamento</Tooltip>}>
                                        <i className="sidenav-mini-icon"> Pagamento </i>
                                    </OverlayTrigger>
                                    <span className="item-name">Pagamento</span>
                                </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/admin/mensalidade' ? 'active' : ''} nav-link`} to="/admin/mensalidade">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
