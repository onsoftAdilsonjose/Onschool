                    ...
                    <Col sm="12" lg="6">
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Image src={img1} className="img-fluid avatar-70" alt="Responsive image" />
                            </Card.Body>
                        </Card>
                        <Card>
                            <Card.Header className="d-flex justify-content-between">
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-center justify-content-between">
                                    <Image src={img11} className="img-thumbnail" alt="Responsive image" />
                                    <Image src={img12} className="img-thumbnail avatar-100" alt="Responsive image" />
                                </div>
                            </Card.Body>
                        </Card>
                        <Card>
