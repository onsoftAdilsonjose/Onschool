...
// React-bootstrap
import { Button, ButtonGroup, Container, Dropdown, Nav, Tab } from 'react-bootstrap'
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-center mt-2">
                                    <Button bsPrefix=" d-flex" href="https://templates.iqonic.design/qompac-ui/pro/documentation/react/dropdowns" target="_blank">
                        ...
                        <Tab.Container defaultActiveKey="first">
                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="first" className=" bd-heading-1 fade show " id="content-dropdown-prv" role="tabpanel" aria-labelledby="typo-output">
                                    ...
                                    <div className="bd-example">
                                        <Dropdown drop={'end'} as={ButtonGroup} className=" w-100 align-items-center flex-wrap">
                                            <div className="dropend" >
                                                <Dropdown.Toggle className="me-1" as={Button} variant="secondary" type="button" id="dropendMenuButton" >
                                                    Dropend button
                                                </Dropdown.Toggle>
                                                <Dropdown.Menu >
                                                    <li><h6 className="dropdown-header">Dropdown header</h6></li>
