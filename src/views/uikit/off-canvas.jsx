...
// React-bootstrap
import { Button, Offcanvas, Row, Col, Dropdown, Container } from 'react-bootstrap'
                        ...
                        <Col lg="6">
                            <Card>
                                ...
                                <div className='card-body'>
                                    ...
                                    <Button variant="primary" onClick={handleShow} className='me-2 mb-2'>
                                        Link with href
                                    </Button>
                                    <Button variant="primary" onClick={handleShow} className='me-2 mb-2'>
                                    ...
                                    <Offcanvas show={show} onHide={handleClose} placement={'start'} >
                                        ...
                                        <Offcanvas.Body>
                                            ...
                                            <Dropdown>
                                                <Dropdown.Toggle variant="secondary mt-2" id="dropdown-basic">
                                                    Dropdown Button
                                                </Dropdown.Toggle>
                            ...
                            <Card>
                                ...
                                <div className='card-body'>
                                    ...
                                    <Button variant="primary" onClick={handleShow2} className='me-2 mb-2'>
                                        Enable body scrolling
                                    </Button>

                                    <Button variant="primary" onClick={handleShow2} className='me-2 mb-2 backdrop-false'>
                                        Enable backdrop (default)
                                    </Button>

                                    <Button variant="primary me-2 mb-2" onClick={handleShow2} className='me-2 mb-2'>
                        ...
                        <Col lg="6">
                            <Card>
                                ...
                                <div className='card-body'>
                                    ...
                                    <Button variant="primary" onClick={handleShow5} className='me-2 mb-2'>
                                    ...
                                    <Button variant="primary" onClick={handleShow6} className='me-2 mb-2'>
                                    ...
                                    <Button variant="primary me-2 mb-2" onClick={handleShow7} className='me-2 mb-2'>
                                        Toggle bottom  offcanvas
                                    </Button>
                                    <Offcanvas show={show7} onHide={handleClose7} placement={'bottom'}>
                                        <Offcanvas.Header closeButton>
                                            <Offcanvas.Title>Offcanvas</Offcanvas.Title>
                                        </Offcanvas.Header>
                                        <Offcanvas.Body>
                                    ...
                                    <Button variant="primary me-2 mb-2" onClick={handleShow8} className='me-2 mb-2'>
                                        Toggle start offcanvas
                                    </Button>

                                    <Offcanvas show={show8} onHide={handleClose8} placement={'start'}>
                                        <Offcanvas.Header closeButton>
                                            <Offcanvas.Title>Offcanvas</Offcanvas.Title>
                                        </Offcanvas.Header>
                                        <Offcanvas.Body>
