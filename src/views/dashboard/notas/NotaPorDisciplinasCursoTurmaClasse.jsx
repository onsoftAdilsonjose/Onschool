...
const NotaPorDisciplinasCursoTurmaClasse = memo(() => {
    ...
    const table1 = [
        {
            name: 'Narciso Fragoso Antonio Ribas',
            mac1: 15,
            npp1:14,
            npt1:15,
            mt1:18,
                                    ...
                                    <Table className="mb-0" id="datatable" data-toggle="data-table">
                                        <thead>
                                            <tr className="bg-white">
                                                ...
                                                <th scope="col">NPT3</th>
                                                <th scope="col">MT3</th>
                                                
                                                <th scope="col">CF</th>
                                                <th scope="col">Estado</th>
                                                <th scope='col'>Lançar nota</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {
                                                table1.map((item, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            {/**Primeiro trismetre */}
                                                            <td className="text-dark">{item.mac1}</td>
                                                            <td className="text-dark">{item.npp1}</td>
                                                            <td className="text-dark">{item.npt1}</td>
                                                            <td className="text-dark">{item.mt1}</td>

                                                             {/**segundo trismetre */}
                                                            <td className="text-dark">{item.mac2}</td>
                                                            <td className="text-dark">{item.npp2}</td>
                                                            <td className="text-dark">{item.npt2}</td>
                                                            <td className="text-dark">{item.mt2}</td>

                                                             {/**Terceiro trismetre */}
                                                            <td className="text-dark">{item.mac3}</td>
                                                            <td className="text-dark">{item.npp3}</td>
                                                            <td className="text-dark">{item.npt3}</td>
                                                            <td className="text-dark">{item.mt3}</td>

                                                            <td className='text-dark'>{item.cf}</td>
                                                            <td className='text-dark'>{item.estado}</td>
...
NotaPorDisciplinasCursoTurmaClasse.displayName = "NotaPorDisciplinasCursoTurmaClasse"
export default NotaPorDisciplinasCursoTurmaClasse