                     ...
                     <Col md="9">
                        <Card className="card  d-flex justify-content-center mb-0 auth-card iq-auth-form">
                           <Card.Body>
                              ...
                              <h2 className="mb-2 text-center">Criar conta</h2>
                              <p className="text-center">Crie a sua conta {appName}.</p>
                              <Form>
                                 <Row>
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="full-name" className="">Primeiro nome</Form.Label>
                                          <Form.Control type="text" className="" id="full-name" placeholder="Jhon" />
                                       </Form.Group>
                                    </Col>
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="last-name" className="">Ultimo nome</Form.Label>
                                    ...
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="phone" className="">Número de telefone.</Form.Label>
                                    ...
                                    <Col lg="6">
                                       <Form.Group className="form-group">
                                          <Form.Label htmlFor="confirm-password" className="">Confirmar palavra passe</Form.Label>
                                    ...
                                    <Col lg="12" className="d-flex justify-content-center">
                                       <Form.Check className="mb-3 form-check">
                                          ...
                                          <Form.Check.Label htmlFor="customCheck1">Concordo com os termos de uso</Form.Check.Label>
                                       </Form.Check>
                                    </Col>
                                 </Row>
                                 <div className="d-flex justify-content-center">
                                    <Button onClick={() => history.push('/')} type="button" variant="primary">Criar</Button>
                                 </div>
                                 <p className="text-center my-3">Ou crie com uma outra conta?</p>
                                 <div className="d-flex justify-content-center">
                                 ...
                                 Já tenho uma conta<Link to="/" className="text-underline"> Entrar</Link>
                                 </p>
                              </Form>
                           </Card.Body>
                        </Card>
