                     ...
                     <Col lg="8">
                        <Card className="d-flex justify-content-center mb-0">
                           <Card.Body>
                              ...
                              <p>Digite o seu email e nós iremos enviar para você um email com instruções para recuperar a sua senha.</p>
                              <form>
                                 <Row>
                                    <Col lg="12">
                                 ...
                                 <Button onClick={() => history.push('/')} type="button" variant="btn btn-primary">Recuperar</Button>
                              </form>
                           </Card.Body>
                        </Card>
                     </Col>
