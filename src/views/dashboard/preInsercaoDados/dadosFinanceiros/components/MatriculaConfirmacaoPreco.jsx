...
import MatriculaConfirmacaoPrecoModal from "../modais/MatriculaConfirmacaoPrecoModal";
...
const MatriculaConfirmacaoPreco= memo(() => {
  ...
  return (
    <Fragment>
      <MatriculaConfirmacaoPrecoModal
                    ...
                    <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="align-items-center">
                                <div className="media-support-info">
                                  <h6 className="mb-0">Informática</h6>
                                </div>
                              </div>
                            </td>
...
MatriculaConfirmacaoPreco.displayName = "MatriculaConfirmacaoPreco";
export default MatriculaConfirmacaoPreco;
