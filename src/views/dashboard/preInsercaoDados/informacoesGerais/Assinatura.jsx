...
import AssinaturaModal from "./modais/AssinaturaModal";
import { GlobalContext } from "../../../../context/GlobalContext";


const Assianatura = memo(() => {
  const [show, setShow] = useState(false);
  const {addAssinatura,assinaturas}=useContext(GlobalContext)
...
Assianatura.displayName = "Assianatura";
export default Assianatura;
