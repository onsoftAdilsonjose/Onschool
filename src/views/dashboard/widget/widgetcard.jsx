...
import { Row, Col, Image, Form, Button, InputGroup, FormControl, Container } from 'react-bootstrap'
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <div className="d-grid gap-card grid-cols-3">
                                    ...
                                    <Link onClick={() => setToggler(!toggler)} to="#">
                                        <Image src={shap5} className="img-fluid bg-soft-danger rounded" alt="profile-image" />
                                    </Link>
                                    <Link onClick={() => setToggler(!toggler)} to="#">
                                        <Image src={shap4} className="img-fluid bg-soft-primary rounded" alt="profile-image" />
                                    </Link>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <ul className="list-inline m-0 p-0">
                                    <li className="d-flex mb-4 align-items-center">
                                        <div className="img-fluid bg-soft-warning rounded-pill"><Image src={shap5} alt="story-img" className="rounded-pill avatar-40" /></div>
