...
const ListaCursoClasseTurmasPorProfessor = memo(() => {
                                                ...
                                                table1.map((item, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="text-dark">{item.classe}</td>
                                                            ...
                                                            <td>
                                                                <div className="d-flex justify-content-evenly">
                                                                    ...
                                                                    <Button onClick={()=>navigate("/admin/lancamentoPorClasseTurmaDisciplinas")} className="btn btn-primary btn-icon btn-sm rounded-pill ms-2" to="#" role="button">
...
ListaCursoClasseTurmasPorProfessor.displayName = "ListaCursoClasseTurmasPorProfessor"
export default ListaCursoClasseTurmasPorProfessor