...
import ListaCursoClasseTurmasPorProfessor from '../professor/ListaCursoClasseTurmasPorProfessor';
               ...
               <Row>
                        ...
                        <Card.Body>
                           <div className="d-flex flex-wrap align-items-center justify-content-between">
                              ...
                              <Nav.Item as="li">
                                 ...
                                 <Nav.Item as="li">
                                    <Nav.Link eventKey="second">Turmas</Nav.Link>
                                 </Nav.Item>
                                 <Nav.Item as="li">
                                    <Nav.Link eventKey="third">Advertências</Nav.Link>
                                 </Nav.Item>
                  ...
                  <Col lg="12">
                     <Tab.Content className="profile-content">
                              ...
                              <Card.Body>
                                 <div className="text-center">
                                    ...
                                    <div className="mt-3">
                                       ...
                                       <p className="d-inline-block pl-3"> - Professor</p>
                           ...
                           <Card>
                              ...
                              <Card.Body>
                                 <div className="user-bio">
                                    <p>Professor a long time.</p>
                                 </div>
                                 <div className="mt-2">
                                    <h6 className="mb-1">Juntou-se a equipa em:</h6>
                                    <p>Feb 15, 2021</p>
                                 </div>
                                 <div className="mt-2">
                                    <h6 className="mb-1">Morada:</h6>
                                    <p>Luanda, Maianga</p>
                                 </div>
                                 <div className="mt-2">
                                    <h6 className="mb-1">Email:</h6>
                                    <p><Link to="#" className="text-body"> narcisoribas@gmail.com</Link></p>
                                 </div>
                                 <div className="mt-2">
                                    <h6 className="mb-1">categoria:</h6>
                                    <p className='text-body'> Catedrático </p>
                                 </div>
                                 <div className="mt-2">
                                    <h6 className="mb-1">Contact:</h6>
                                    <p><Link to="#" className="text-body">(244) 999 565 456</Link></p>
                                 </div>
                              </Card.Body>
                           </Card>
                        </Tab.Pane >

                        {/**Turmas em que o professor passa */}
                        <Tab.Pane eventKey="second" id="profile-class">
                           <Card>
                              <Card.Header>
                                 <div className="header-title">
                                    <h4 className="card-title">Minhas turmas</h4>
                                 </div>
                              </Card.Header>
                              <Card.Body>
                                <ListaCursoClasseTurmasPorProfessor/>
                              </Card.Body>
                           </Card>
                        </Tab.Pane >
                        ...
                        {/**Advertencias */}
                        <Tab.Pane eventKey="third" id="profile-conflites">
                           <Card>
