            ...
            <Row>
                <Col lg="8" xl="8">
                    <Card className="card-block card-stretch card-height">
                        <Card.Header>
                            <div className="flex-wrap  d-flex justify-content-between">
                                ...
                                <div className="d-flex">
                                    <div className="me-3">
                                        <p className="mb-0"><svg className="text-primary" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="5" cy="5" r="5" fill="currentColor" />
                                        </svg>  Total Sales </p>
                                    </div>
                                    <div className="me-3">
                                        <p className="mb-0"><svg className="text-secondary" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="5" cy="5" r="5" fill="currentColor" />
                                        </svg> Total Expense</p>
                                    </div>
                                    <div className="">
                                        <p className="mb-0"><svg className="text-tertiray" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="5" cy="5" r="5" fill="currentColor" />
                                        </svg>  Total Profit</p>
                                    </div>
                                </div>
                        ...
                        <Card.Body>
                            <Chart options={chart2.options} series={chart2.series} type="line" height="100%" className="sales-chart-02"></Chart>
                        </Card.Body>
                    </Card>
                </Col>
                <Col lg="4" xl="4">
                    <Card className="card-block card-stretch card-height">
                        ...
                        <Card.Body>
                            <div className="course-picker">
                                <Flatpickr className="d-none w-100" options={{ inline: true, minDate: 'today' }} />
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className="card card-block card-stretch card-height">
                        <Card.Body>
                            <div className="mb-5">
                                ...
                                <div className="">
                                    <h2 className="counter mb-2" style={{ visibility: "visible" }}>$46,996</h2>
                                    <p>This Month</p>
                                </div>
                            </div>
                            <div>
                                <div className="d-flex gap flex-column">
                                    <div className="d-flex align-items-center gap-3">
                                        <div className="bg-soft-primary avatar-60 rounded">
                                            <svg className="icon-35" width="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div style={{ width: "100%" }}>
                                            ...
                                            <div className="progress bg-soft-primary shadow-none w-100" style={{ height: "6px" }}>
                                                <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="23" aria-valuemin="0" aria-valuemax="100" style={{ width: "23%", transition: "width 2s ease 0s" }}></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="d-flex align-items-center gap-3">
                                        ...
                                        <div style={{ width: "100%" }}>
                                            ...
                                            <div className="progress bg-soft-info shadow-none w-100" style={{ height: "6px" }}>
                                                <div className="progress-bar bg-info" data-toggle="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={{ width: "40%", transition: "width 2s ease 0s" }}></div>
                                            </div>
                                        </div>
                                        ...
                                        <div style={{ width: "100%" }}>
                                            ...
                                            <div className="progress bg-soft-success shadow-none w-100" style={{ height: "6px" }}>
                                                <div className="progress-bar bg-success" data-toggle="progress-bar" role="progressbar" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100" style={{ width: "82%", transition: "width 2s ease 0s" }}></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="d-flex align-items-center gap-3">
                                        ...
                                        <div style={{ width: "100%" }}>
                                            ...
                                            <div className="progress bg-soft-danger shadow-none w-100" style={{ height: "6px" }}>
                                                <div className="progress-bar bg-danger" data-toggle="progress-bar" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" style={{ width: "15%", transition: "width 2s ease 0s" }}></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <Col lg="8" xl="8">
                    <Card className="card-block card-stretch card-height">
                        <div className="flex-wrap card-header d-flex justify-content-between">
                            ...
                            <Dropdown>
                                <Dropdown.Toggle as={CustomToggle} to='#' variant="text-gray dropdown-toggle" size="sm" id="dropdownMenuButton22">
                                    This year
                                </Dropdown.Toggle>
                                <Dropdown.Menu>
                                ...
                                <table id="basic-table" className="table mb-0 table-striped" role="grid">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={shap1} alt="" className="rounded bg-soft-primary img-fluid avatar-40 me-3" loading="lazy" />
                                            ...
                                            <td>
                                                ...
                                                <div className="shadow-none progress bg-soft-primary w-100" style={{ height: "4px" }}>
                                                    <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={{ width: "60%", transition: "width 2s ease 0s" }}></div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={shap5} alt="" className="rounded bg-soft-primary img-fluid avatar-40 me-3" loading="lazy" />
                                            ...
                                            <td>
                                                ...
                                                <div className="shadow-none progress bg-soft-primary w-100" style={{ height: "4px" }}>
                                                    <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style={{ width: "25%", transition: "width 2s ease 0s" }}></div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={shap2} alt="" className="rounded bg-soft-primary img-fluid avatar-40 me-3" loading="lazy" />
                                            ...
                                            <td>
                                                ...
                                                <div className="shadow-none progress bg-soft-success w-100" style={{ height: "4px" }}>
                                                    <div className="progress-bar bg-success" data-toggle="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style={{ width: "100%", transition: "width 2s ease 0s" }}></div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={shap3} alt="" className="rounded bg-soft-primary img-fluid avatar-40 me-3" loading="lazy" />
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <img src={shap4} alt="" className="rounded bg-soft-primary img-fluid avatar-40 me-3" loading="lazy" />
                                            ...
                                            <td>
                                                ...
                                                <div className="shadow-none progress bg-soft-primary w-100" style={{ height: "4px" }}>
                                                    <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style={{ width: "75%", transition: "width 2s ease 0s" }}></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <Card className="card-block card-stretch card-height">
                        <Card.Header>
                            <div className='flex-wrap d-flex justify-content-between'>
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray dropdown-toggle" size="sm" id="dropdownMenuButton29">
                                        This year
                                    </Dropdown.Toggle>
                                    <Dropdown.Menu>
                                        <Dropdown.Item to='#'>This Year</Dropdown.Item>
                        ...
                        <Card.Body>
                            <Chart options={chart3.options} series={chart3.series} type="donut" height="100%" className="sales-chart-04"></Chart>
                        </Card.Body>
                    </Card>
                </Col>
                <Col lg="4" md="6" sm="12">
                    <Card className="card-block card-stretch card-height">
                        <Card.Header>
                            <div className='flex-wrap  d-flex justify-content-between'>
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray dropdown-toggle" size="sm" id="dropdownMenuButton24">
                                        This year
                                    </Dropdown.Toggle>
                                    <Dropdown.Menu>
                                        <Dropdown.Item to='#'>This Year</Dropdown.Item>
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-between  mb-3">
                                <div className="w-100">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="progress bg-soft-success shadow-none w-50" style={{ height: "6px" }}>
                                            <div className="progress-bar bg-success" data-toggle="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style={{ width: "80%", transition: "width 2s ease 0s" }}></div>
                                        </div>
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray" size="sm" id="dropdownMenuButton25">
                            ...
                            <div className="d-flex justify-content-between  mb-3">
                                <div className="w-100">
                                    <h6>Fashion Theme</h6>
                                    <div className="d-flex align-items-center">
                                        <div className="progress bg-soft-danger shadow-none w-50" style={{ height: "6px" }}>
                                            <div className="progress-bar bg-danger" data-toggle="progress-bar" role="progressbar" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100" style={{ width: "18%", transition: "width 2s ease 0s" }}></div>
                                        </div>
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray" size="sm" id="dropdownMenuButton61">
                                        <svg width="22" height="5" viewBox="0 0 22 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M19.6788 5C20.9595 5 22 3.96222 22 2.68866C22 1.41318 20.9595 0.373465 19.6788 0.373465C18.3981 0.373465 17.3576 1.41318 17.3576 2.68866C17.3576 3.96222 18.3981 5 19.6788 5ZM11.0005 5C12.2812 5 13.3217 3.96222 13.3217 2.68866C13.3217 1.41318 12.2812 0.373465 11.0005 0.373465C9.71976 0.373465 8.67929 1.41318 8.67929 2.68866C8.67929 3.96222 9.71976 5 11.0005 5ZM4.64239 2.68866C4.64239 3.96222 3.60192 5 2.3212 5C1.04047 5 0 3.96222 0 2.68866C0 1.41318 1.04047 0.373465 2.3212 0.373465C3.60192 0.373465 4.64239 1.41318 4.64239 2.68866Z" fill="currentColor" />
                                        </svg>
                                    </Dropdown.Toggle>
                            ...
                            <div className="d-flex justify-content-between  mb-3">
                                <div className="w-100">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="progress bg-soft-primary shadow-none w-50" style={{ height: "6px" }}>
                                            <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100" style={{ width: "18%", transition: "width 2s ease 0s" }}></div>
                                        </div>
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray" size="sm" id="dropdownMenuButton62">
                                        <svg width="22" height="5" viewBox="0 0 22 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M19.6788 5C20.9595 5 22 3.96222 22 2.68866C22 1.41318 20.9595 0.373465 19.6788 0.373465C18.3981 0.373465 17.3576 1.41318 17.3576 2.68866C17.3576 3.96222 18.3981 5 19.6788 5ZM11.0005 5C12.2812 5 13.3217 3.96222 13.3217 2.68866C13.3217 1.41318 12.2812 0.373465 11.0005 0.373465C9.71976 0.373465 8.67929 1.41318 8.67929 2.68866C8.67929 3.96222 9.71976 5 11.0005 5ZM4.64239 2.68866C4.64239 3.96222 3.60192 5 2.3212 5C1.04047 5 0 3.96222 0 2.68866C0 1.41318 1.04047 0.373465 2.3212 0.373465C3.60192 0.373465 4.64239 1.41318 4.64239 2.68866Z" fill="currentColor" />
                                        </svg>
                                    </Dropdown.Toggle>
                            ...
                            <div className="d-flex justify-content-between  mb-3">
                                <div className="w-100">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="progress bg-soft-gray shadow-none w-50" style={{ height: "6px" }}>
                                            <div className="progress-bar bg-secondary" data-toggle="progress-bar" role="progressbar" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100" style={{ width: "35%", transition: "width 2s ease 0s" }}></div>
                                        </div>
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray" size="sm" id="dropdownMenuButton63">
                                        <svg width="22" height="5" viewBox="0 0 22 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M19.6788 5C20.9595 5 22 3.96222 22 2.68866C22 1.41318 20.9595 0.373465 19.6788 0.373465C18.3981 0.373465 17.3576 1.41318 17.3576 2.68866C17.3576 3.96222 18.3981 5 19.6788 5ZM11.0005 5C12.2812 5 13.3217 3.96222 13.3217 2.68866C13.3217 1.41318 12.2812 0.373465 11.0005 0.373465C9.71976 0.373465 8.67929 1.41318 8.67929 2.68866C8.67929 3.96222 9.71976 5 11.0005 5ZM4.64239 2.68866C4.64239 3.96222 3.60192 5 2.3212 5C1.04047 5 0 3.96222 0 2.68866C0 1.41318 1.04047 0.373465 2.3212 0.373465C3.60192 0.373465 4.64239 1.41318 4.64239 2.68866Z" fill="currentColor" />
                                        </svg>
                                    </Dropdown.Toggle>
                            ...
                            <div className="d-flex justify-content-between">
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as={CustomToggle} variant="text-gray" size="sm" id="dropdownMenuButton64">
                                        <svg width="22" height="5" viewBox="0 0 22 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M19.6788 5C20.9595 5 22 3.96222 22 2.68866C22 1.41318 20.9595 0.373465 19.6788 0.373465C18.3981 0.373465 17.3576 1.41318 17.3576 2.68866C17.3576 3.96222 18.3981 5 19.6788 5ZM11.0005 5C12.2812 5 13.3217 3.96222 13.3217 2.68866C13.3217 1.41318 12.2812 0.373465 11.0005 0.373465C9.71976 0.373465 8.67929 1.41318 8.67929 2.68866C8.67929 3.96222 9.71976 5 11.0005 5ZM4.64239 2.68866C4.64239 3.96222 3.60192 5 2.3212 5C1.04047 5 0 3.96222 0 2.68866C0 1.41318 1.04047 0.373465 2.3212 0.373465C3.60192 0.373465 4.64239 1.41318 4.64239 2.68866Z" fill="currentColor" />
                                        </svg>
                                    </Dropdown.Toggle>
                        ...
                        <Card.Body>
                            ...
                            <div className="d-flex align-items-top">
                                ...
                                <div className="profile-media ms-3 d-flex">
                                    ...
                                    <div className="ms-3">
                                        <h6 className="mb-0">New order placed #8744152 of 3D Icons</h6>
                                    </div>
                                </div>
                            </div>
                            <div className="d-flex align-items-top">
                            ...
                            <div className="d-flex align-items-top">
                                ...
                                <div className="profile-media ms-3 d-flex">
                                    <div className="profile-dots-pills border-warning"></div>
                                    <div className="ms-3">
                                        <h6 className="mb-0">New order Placed <span className="text-primary">#87444892</span> of Dashboard</h6>
                                    </div>
                                </div>
                            </div>
                        </Card.Body>
