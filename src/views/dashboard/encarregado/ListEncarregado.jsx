...
import AddEncarregado from "./AddEncarregado"
...
const handleFilterChange = (event) => {
 ...
 const paginationOptions = {
   ...
   return (
      <Fragment>
        <AddEncarregado handleClose={handleClose} show={show}/>
       <Container>
        <Row>
          <Col lg="12">
            <Card>
...
ListEncarregado.displayName = "ListEncarregado"
export default ListEncarregado;